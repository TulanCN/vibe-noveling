---
name: novel-snapshot
description: 当用户需要为当前小说项目创建快照、备份状态或恢复历史版本时使用。
when_to_use: |
  适用于“创建快照”“保存进度”“备份项目”“novel-snapshot”“打版本”“存个档”“恢复快照”“回滚”“回到之前”等请求。
  包含创建快照和恢复快照两类操作；恢复前会先备份当前状态。
---
